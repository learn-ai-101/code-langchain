...
def implement_llama_4_model():
    ...
    """
    # TODO: Your implementation here
    client = ChatGroq(model="llama-4-8b-instant", temperature=0)
    return client
...
def implement_compare_models(prompt):
    ...
    comparison[0] = implement_query_model(llama3, prompt)
    comparison[1] = implement_query_model(llama4, prompt)
